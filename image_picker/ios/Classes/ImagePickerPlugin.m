...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  ...
  if ([@"pick" isEqualToString:call.method]) {
    ...
    UIAlertAction *camera = [UIAlertAction actionWithTitle:[self localizeString:@"Take Photo"]
                                                     style:UIAlertActionStyleDefault
                                                   handler:^(UIAlertAction *action) {
                                                     [self showCamera];
                                                   }];
    UIAlertAction *library = [UIAlertAction actionWithTitle:[self localizeString:@"Choose Photo"]
                                                      style:UIAlertActionStyleDefault
                                                    handler:^(UIAlertAction *action) {
                                                      [self showPhotoLibrary];
                                                    }];
    UIAlertAction *cancel =
        [UIAlertAction actionWithTitle:[self localizeString:@"Cancel"] style:UIAlertActionStyleCancel handler:nil];
